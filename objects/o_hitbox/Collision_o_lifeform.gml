...
repeat(4){
	instance_create_layer(other.x + random_range(-other.sprite_width / 10, other.sprite_width / 10), other.y - other.sprite_height / 10, "Blood", o_hit_effect);
}
...
if instance_exists(o_abiturientis) {
	...
	if other.object_index == o_abiturientis {
		audio_play_sound(a_take_hit, 5, false);
		if creator.object_index == o_boss {
			add_screenshake(50, 8);
		} else {
